<?php
/**
 * Title: Welcome section with text.
 * Slug: avant-garde/general-welcome-text
 * Categories: avant-garde-general
 * Viewport Width: 1280
 */

?>
<!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"0px"}},"layout":{"inherit":false,"wideSize":"1280px"}} -->
